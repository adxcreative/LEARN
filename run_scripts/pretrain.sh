...
# data options
train_data=./amazon_reviews/amazon_2018/pretrain_data/
emb_path=./amazon_2018/item_embeddings/item_baichuan_lmdb
input_dim=4096
output_dim=4096
...
# output options
output_base_dir=./exp/
name=pretrain_u2iLoss_pred-next-item_ep30_warmup1
